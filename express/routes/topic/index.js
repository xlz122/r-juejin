...
router.get('/topic-list', function(req, res, next) {
  let imageUrl = 'http://localhost:9000/images/topic';
  let itemArr = [
    {
      imgUrl: `${imageUrl}/list-image1.jpg`,
      title: '上班摸鱼',
    ...
    {
      imgUrl: `${imageUrl}/list-image2.jpg`,
      title: '一图胜千言',
      tooltip: '能用图，就不要用字。',
      followCount: 5934,
    ...
    {
      imgUrl: `${imageUrl}/list-image3.jpg`,
      title: '今天学到了',
    ...
    {
      imgUrl: `${imageUrl}/list-image4.jpg`,
      title: '树洞一下',
    ...
    {
      imgUrl: `${imageUrl}/list-image5.jpg`,
      title: '今日最佳',
    ...
    {
      imgUrl: `${imageUrl}/list-image6.jpg`,
      title: '提问回答',
    ...
    {
      imgUrl: `${imageUrl}/list-image7.jpg`,
      title: '掘金相亲',
    ...
    {
      imgUrl: `${imageUrl}/list-image8.jpg`,
      title: '优秀开源推荐',
    ...
    {
      imgUrl: `${imageUrl}/list-image9.jpg`,
      title: '内推招聘',
    ...
    {
      imgUrl: `${imageUrl}/list-image10.jpg`,
      title: '应用安利',
