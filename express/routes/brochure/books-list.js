...
const imageUrl = `${config.imageBaseUrl}/brochure`;

const list = [
  {
    imgUrl: `${imageUrl}/book-image1.jpg`,
    title: '深入浅出 PWA',
    desc: '理论结合实践，帮助开发者全方位地掌握现代 Web 技术体系中的 PWA 架构。',
    authorUrl: `${imageUrl}/author-image1.jpg`,
    username: '泪已无痕',
    gradeImgUrl: `${imageUrl}/grade-image2.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image2.jpg`,
    title: 'Uniapp 从入门到进阶',
    desc: '从基础到实战，详细讲解跨平台应用开发的方方面面，包含 Uniapp 开发常用知识点，基础 api，前端交互、组件封装，后端 Nodejs 开发、前后端联调和调优部署，是一套非常全面的综合课程。',
    authorUrl: `${imageUrl}/author-image2.jpg`,
    username: '阿面',
    gradeImgUrl: `${imageUrl}/grade-image1.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image4.jpg`,
    title: 'MySQL 是怎样运行的：从根儿上理解 MySQL',
    desc: '授人以鱼不如授人以渔，从根儿上理解 MySQL，让 MySQL 不再是一个黑盒。',
    authorUrl: `${imageUrl}/author-image4.jpg`,
    username: '小孩子4919',
    gradeImgUrl: `${imageUrl}/grade-image3.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image5.jpg`,
    ...
    authorUrl: `${imageUrl}/author-image5.jpg`,
    username: 'zz_jesse',
    gradeImgUrl: `${imageUrl}/grade-image3.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image6.jpg`,
    title: 'React Hooks 与 Immutable 数据流实战',
    desc: '以实战为线索，逐步深入React开发各个环节，掌握前端常用性能体验优化思路，打造完整前端工作流，提升工程化编码能力和思维能力。',
    authorUrl: `${imageUrl}/author-image6.jpg`,
    username: '神三元',
    gradeImgUrl: `${imageUrl}/grade-image6.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image8.jpg`,
    title: 'JVM 字节码从入门到精通',
    desc: '深入剖析 JVM 字节码，带你分析字节码黑科技、破解软件、从零实现一个 APM',
    authorUrl: `${imageUrl}/author-image8.jpg`,
    username: '挖坑的张师傅',
    gradeImgUrl: `${imageUrl}/grade-image3.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image9.jpg`,
    title: 'Kubernetes 从上手到实践',
    desc: '从上手实践到原理剖析，带你掌握 Kubernetes 必备技能。',
    authorUrl: `${imageUrl}/author-image9.jpg`,
    username: '张晋涛',
    gradeImgUrl: `${imageUrl}/grade-image4.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image10.jpg`,
    title: 'MySQL 是怎样使用的：从零蛋开始学习 MySQL',
    desc: '来来来，你什么都不用会，真正的从零蛋开始系统又轻松地学习MySQL。',
    authorUrl: `${imageUrl}/author-image10.jpg`,
    username: '小孩子4919',
    gradeImgUrl: `${imageUrl}/grade-image5.svg`,
    authorDesc: '公众号「我们都是小青蛙」作者，专注将复杂概念简单化。',
    price: 19.9,
    chapter: 22,
    read: '331分',
  ...
  {
    imgUrl: `${imageUrl}/book-image11.jpg`,
    title: '程序员职业小白书 —— 如何规划和经营你的职业',
    desc: '职业上的错误是不能回滚的，将陪伴你一生，帮助每一位程序员规划自己的职业生涯',
    authorUrl: `${imageUrl}/author-image11.jpg`,
    username: 'Easy',
    gradeImgUrl: `${imageUrl}/grade-image2.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image12.jpg`,
    title: '数字货币与区块链原理',
    desc: '深入了解区块链、挖矿、钱包、签名等技术原理，对未来的数字货币世界做好准备',
    authorUrl: `${imageUrl}/author-image12.jpg`,
    username: '廖雪峰',
    gradeImgUrl: `${imageUrl}/grade-image4.svg`,
  ...
  {
    imgUrl: `${imageUrl}/book-image13.jpg`,
    title: '响应式编程 —— RxJava 高阶指南',
    desc: '研究响应式编程，探讨 ReactiveX 的底层概念和 RxJava 的高阶问题',
    authorUrl: `${imageUrl}/author-image13.jpg`,
    username: '拉丁吴',
    gradeImgUrl: `${imageUrl}/grade-image5.svg`,
